"""s_project_read_viirs_samples (1).ipynb
...
if __name__ == "__main__":
  ...
  model = torch.load(args.model_saving_path + '/saved_model_2016_M8_M16model.pth')
  ...
  for ind_file in v02_files:
      ...
      out_pred_path = '/umbc/rs/nasa-access/xin/cloud-phase-prediction/data/predict_2016_M8M16/2017/001/'
