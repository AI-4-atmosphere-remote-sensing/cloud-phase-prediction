...
root = '/umbc/rs/nasa-access/data/calipso-viirs-merged' + '/' + year + '/'
...
sav_path = '/umbc/rs/nasa-access/data/calipso-viirs-merged'
...
for doy in range(1,days+1): 
    ...
    np.savez(sav_path + '/' + year + '.npz', calipso=calipso_all, viirs=viirs_all, iff = iff_all, latlon = latlon_all, label = label_all)
    _ = test_data.seek(0)    
