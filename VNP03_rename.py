...
source_folder_path = '/umbc/rs/nasa-access/data/viirs_data/VNP03MOD/2017/031'
destination_folder_path = '/umbc/rs/nasa-access/xin/cloud-phase-prediction/data/VNP03MOD/2017/031'
...
for filename in filenames:
    ...
    new_filename = "VNP03_" + parts[1] + "." + parts[2] + ".nc"
