...
def loadSingleGranuleData(sc_X):
    ...
    viirs_data = np.stack((v03_sza, v03_saa, v03_vza, v03_vaa, v02_obs[:, :, 0], v02_obs[:, :, 1], v02_obs[:, :, 2],
                           v02_obs[:, :, 3], v02_obs[:, :, 4], v02_obs[:, :, 5], v02_obs[:, :, 6], v02_obs[:, :, 7],
                           v02_obs[:, :, 8], v02_obs[:, :, 9], v02_obs[:, :, 10], v02_obs[:, :, 11], v02_obs[:, :, 12],
                           v02_obs[:, :, 13], v02_obs[:, :, 14], v02_obs[:, :, 15], v03_lat, v03_lon), axis=-1)
...
if __name__ == "__main__":
    ...
    # model = torch.load(args.model_saving_path + '/model_classifier_best.pt')
...
# VAE predict
 #python predict_chenxi_onlyM16_vae.py --predicting_data_path='/Users/nizhao/xin/access/data/'  --model_saving_path='/Users/nizhao/xin/access/data/weak/saved_model/' --export_data_path='/Users/nizhao/xin/access/data/'
