...
if __name__ == "__main__":
  ...
  data_all = np.array([])
  data_all = np.empty((0,22), float)

  # evaluate on the testing data
  test_files = glob.glob(args.predicting_data_path + '/*hdf5')
  for test_file in test_files:
    offtrack_data = loadOffTrackData(test_file, sc_X)
    data_all = vstack((data_all, offtrack_data))

  print("data_all.shape:", data_all.shape)
  print("data_all:", data_all)
  out_dir = args.export_data_path
  file_name = 'ben_off_track_data_all_2022_05_01.npz'

  test_data = TemporaryFile()
  np.savez(out_dir + file_name , offtrackdata=data_all)
  _ = test_data.seek(0)

  # read the saved file
  # savedData = np.load(out_dir+file_name)
  # print('savedData:', savedData)
  # print('savedData[offtrackdata].shape:', savedData['offtrackdata'].shape)
  # print('savedData[offtrackdata]:', savedData['offtrackdata'])
...
# python prepare_offtrack_data.py --predicting_data_path='/Users/nizhao/xin/access/newdata/from_ben/'  --model_saving_path='./saved_model/' --export_data_path='/Users/nizhao/xin/access/newdata/offtrack_out/'
